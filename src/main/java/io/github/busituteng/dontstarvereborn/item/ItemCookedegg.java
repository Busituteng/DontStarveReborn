...
public class ItemCookedegg extends ElementsDontstarverebornMod.ModElement {
	@GameRegistry.ObjectHolder("dontstarvereborn:cookedegg")
	public static final Item block = null;
	public ItemCookedegg(ElementsDontstarverebornMod instance) {
		super(instance, 40);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("dontstarvereborn:cookedegg", "inventory"));
	}
