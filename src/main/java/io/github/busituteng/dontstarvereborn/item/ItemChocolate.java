...
public class ItemChocolate extends ElementsDontstarverebornMod.ModElement {
	@GameRegistry.ObjectHolder("dontstarvereborn:chocolate")
	public static final Item block = null;
	public ItemChocolate(ElementsDontstarverebornMod instance) {
		super(instance, 37);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("dontstarvereborn:chocolate", "inventory"));
	}
