...
public class ItemCheese extends ElementsDontstarverebornMod.ModElement {
	@GameRegistry.ObjectHolder("dontstarvereborn:cheese")
	public static final Item block = null;
	public ItemCheese(ElementsDontstarverebornMod instance) {
		super(instance, 34);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("dontstarvereborn:cheese", "inventory"));
	}
